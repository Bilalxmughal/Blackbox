...
import { X, Send, User, Clock, Calendar, MessageSquare } from 'lucide-react'
...
function TicketDetail({ 
  ...
  const deptUsers = departments.find(d => d.name === reassignData.dept)?.users || []
      ...
      <div className={styles.detailContainer}>
        ...
        <div className={styles.mainContent}>
          <div className={styles.leftPanel}>
            ...
            <div className={styles.section}>
              <h3>Issue Details</h3>
              <p className={styles.issueText}>{ticket.issueDetails}</p>
            ...
            {isReassignMode && (
              <div className={styles.section}>
                ...
                <div className={styles.reassignForm}>
                  ...
                  <button onClick={handleReassign} className={styles.reassignBtn}>
                    Confirm Reassign
                  </button>
                </div>
              </div>
            ...
            <div className={styles.commentsList}>
              {(ticket.comments || []).length === 0 ? (
                ...
                ticket.comments.map(comment => (
                  <div 
                    key={comment.id} 
                    className={`${styles.comment} ${styles[comment.type]}`}
                  >
                    <div className={styles.commentHeader}>
                      <span className={styles.commentBy}>{comment.by}</span>
